...
/** Add your docs here. */
public class RedF4D4C4 extends AutoBase {
    private static final Path startPath = PathsBase.R_SR_F;
    private static final Path load1 = PathsBase.R_F_RL;
