...
public class CoralReefAlign extends AlignWithFieldElementCommand {

  private final VisionSubsystem vision = VisionSubsystem.getInstance();
  private PhotonTrackedTarget camTarget = new PhotonTrackedTarget();
  private final boolean exclusive;

  public CoralReefAlign(
      AlignOffset offset,
      boolean exclusive,
      DoubleSupplier xVal,
      DoubleSupplier yVal,
    ...
    SuperstructureSubsystem.getInstance().setAlignmentOffset(offset);
  ...
  public void initialize() {
    VisionSubsystem.getInstance().setPrimaryFocus(TagTrackerType.CORAL_REEF_CAM);
    super.initialize();
  }
}
