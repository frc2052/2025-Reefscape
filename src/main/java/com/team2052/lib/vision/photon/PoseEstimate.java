...
public class PoseEstimate {
    ...
    public PoseEstimate(
            String cameraName, double cameraWeight, EstimatedRobotPose photonData, Pose2d currentRobotPose) {
        ...
        poseDifference =
                estimatedPose.getTranslation().toTranslation2d().getDistance(currentRobotPose.getTranslation());
    }
    ...
    private double calculateXYStdDevs() {
        ...
        double xyStdDev = xyStdDevCoefficient * Math.pow(avgTagDistance, 2.0) / targetsUsed.size() * cameraWeight;
