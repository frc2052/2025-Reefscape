...
public class TagTracker {
    ...
    public TagTracker(TagTrackerConstants camConstants, RobotState robotState) {
        ...
        this.poseEstimator =
                new PhotonPoseEstimator(camConstants.tagLayout, camConstants.strategy, camConstants.robotToCamera);
    ...
    public static class TagTrackerConstants {
        ...
        public TagTrackerConstants(
                String name, Transform3d robotToCamera, AprilTagFieldLayout tayLayout, PoseStrategy strategy) {
            this.name = name;
